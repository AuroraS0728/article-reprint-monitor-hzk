        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "report_type",
                    models.CharField(
                        choices=[("DAILY", "日报"), ("WEEKLY", "周报")], max_length=16
                    ),
                ),
                (
                    "report_date",
                    models.DateField(db_index=True, help_text="日报日期或周报周一日期"),
                ),
                ...
                (
                    "report_file",
                    models.FileField(
                        max_length=300, upload_to=apps.reports.models.report_upload_path
                    ),
                ),
