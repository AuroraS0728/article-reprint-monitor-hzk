...
from apps.sources.views import (
    ...
    SearchProviderConfigurationDetailView,
    SearchProviderConfigurationListCreateView,
...
urlpatterns = [
    ...
    path("search-providers", SearchProviderConfigurationListCreateView.as_view()),
    path("search-providers/<int:pk>", SearchProviderConfigurationDetailView.as_view()),
