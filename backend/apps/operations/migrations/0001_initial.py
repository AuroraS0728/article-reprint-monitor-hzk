        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "status",
                    models.CharField(
                        choices=[("RUNNING", "运行中"), ("SUCCEEDED", "成功"), ("FAILED", "失败"), ("SKIPPED", "跳过")],
                        default="RUNNING",
                        max_length=16,
                    ),
                ),
                (
                    "backup_file",
                    models.FileField(blank=True, max_length=300, upload_to=apps.operations.models.database_backup_path),
                ),
            ...
            options={"db_table": "operations_database_backup", "ordering": ["-created_at", "-id"]},
        ),
        migrations.CreateModel(
            name="MaintenanceRun",
            fields=[
            ...
            options={"db_table": "operations_maintenance_run", "ordering": ["-started_at", "-id"]},
        ),
        migrations.CreateModel(
